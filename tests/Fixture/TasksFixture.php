...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_concluido_id' => ['type' => 'uuid', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'user_concluido_id' => ['type' => 'index', 'columns' => ['user_concluido_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'tasks_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_concluido_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'prioridade' => 1,
            'user_id' => '756fb685-14fc-49bd-af86-d1eb5acf4f68',
            'status' => 1,
            'user_concluido_id' => '5489de01-e880-4744-8b0a-4e01419ee354',
            'ativo' => 1,
            'criado' => '2017-12-07 17:43:56',
            'modificado' => '2017-12-07 17:43:56'
        ],
    ];
}
